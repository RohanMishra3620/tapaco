...
<div class="cat-ritual" style="padding:44px 24px 36px">
  <p style="font-size:.6rem;font-weight:800;letter-spacing:.22em;text-transform:uppercase;color:rgba(255,255,255,.4);margin-bottom:10px">Sacred Texts</p>
  <h1 style="font-family:'Cormorant Garamond',serif;font-size:2.4rem;font-weight:700;color:#fff;line-height:1.05;margin-bottom:10px">Ritual Guides</h1>
  <p style="font-size:.92rem;color:rgba(255,255,255,.62);line-height:1.65;margin-bottom:22px;max-width:300px">Step-by-step vidhi for every puja. Written by Vedic scholars. Free to read, forever.</p>
  <!-- Mini search bar -->
  <div style="position:relative;max-width:360px">
    ...
    <input type="text" placeholder="Search puja or festival…" onclick="window.location='<?= base_url('search') ?>'"
      style="width:100%;padding:13px 16px 13px 40px;border-radius:10px;border:none;font-size:.88rem;background:#fff;color:#130700;outline:none;cursor:pointer;box-sizing:border-box">
  </div>
</div>
...
<!-- SUBSCRIBE NUDGE -->
<div style="margin:14px 16px 0;padding:22px;background:linear-gradient(135deg,#0E2A14,#1C5228);border-radius:20px">
  ...
  <p style="font-family:'Cormorant Garamond',serif;font-size:1.4rem;font-weight:700;color:#fff;line-height:1.2;margin-bottom:6px">Get ritual reminders on WhatsApp</p>
  ...
  <a href="<?= base_url('subscribe?from=ritual-guides') ?>" style="display:inline-flex;align-items:center;gap:7px;background:#fff;color:#1C5228;font-size:.8rem;font-weight:800;padding:12px 20px;border-radius:10px;text-decoration:none">
...
<div style="margin:14px 16px 28px;padding:16px 18px;background:#FFF9F0;border:1px solid #EDE0C8;border-radius:16px;display:flex;align-items:center;gap:14px">
  ...
  <a href="<?= base_url('purohit-puja') ?>" style="background:#7A1E12;color:#fff;font-size:.74rem;font-weight:700;padding:9px 13px;border-radius:9px;text-decoration:none;white-space:nowrap">Book →</a>
</div>
