...
<div class="cat-bhajan" style="padding:44px 24px 36px">
  ...
  <div style="display:flex;gap:10px;flex-wrap:wrap">
    <a href="#mandalis" style="display:inline-flex;align-items:center;gap:7px;background:#fbc04a;color:#870000;font-size:.82rem;font-weight:800;padding:13px 22px;border-radius:10px;text-decoration:none">Book a Mandali →</a>
...
<!-- PERFECT FOR CHIPS -->
<div style="padding:20px 16px 18px;background:#870000;border-bottom:1px solid #870000;">
  <p style="font-size:.58rem;font-weight:800;letter-spacing:.2em;text-transform:uppercase;color:#;margin-bottom:14px">Perfect For</p>
  <div style="display:flex;gap:8px;flex-wrap:wrap">
    ...
    <span style="display:inline-block;font-size:.75rem;font-weight:600;padding:7px 14px;border-radius:20px;background:#F5F0FF;color:#870000;border:1px solid #D4C8F0"><?= $ev ?></span>
    <?php endforeach; ?>
  </div>
</div>
...
<div style="padding:24px 20px;background:#FDFCF9;border-bottom:1px solid #EDE5D8">
  <p style="font-size:.58rem;font-weight:800;letter-spacing:.22em;text-transform:uppercase;color:#870000;margin-bottom:18px">What's Included</p>
...
<div id="mandalis" style="padding:24px 16px 8px">
  ...
  <div class="card-grid">
    ...
    <a href="<?= base_url('bhajan-mandali/'.$m['slug']) ?>" class="lotus-card reveal"
       style="display:flex;align-items:center;gap:14px;background:#FEF5C7;border:1px solid #EDE5D8;border-radius:16px;padding:16px;text-decoration:none">
      <div style="width:48px;height:48px;border-radius:13px;background:rgba(135,0,0,.07);display:flex;align-items:center;justify-content:center;flex-shrink:0">
        <svg width="22" height="22" fill="none" stroke="#870000" stroke-width="1.7" viewBox="0 0 24 24"><use href="#ic-music"/></svg>
      </div>
      <div style="flex:1;min-width:0">
        ...
        <span style="font-size:.72rem;font-weight:700;color:#870000">From ₹<?= number_format($m['starting_price']) ?></span>
        <?php endif; ?>
      </div>
    ...
    <a href="https://wa.me/919999999999?text=I+want+to+book+a+Bhajan+Mandali" target="_blank"
       class="reveal" style="grid-column:1/-1;display:flex;align-items:center;justify-content:center;gap:10px;padding:18px;border:2px dashed #D4C8F0;border-radius:16px;color:#870000;font-size:.85rem;font-weight:600;text-decoration:none;background:#F9F7FF">
...
<!-- HOW BOOKING WORKS -->
<div style="margin:16px 16px 0;padding:22px;background:#FEF5C7;border:1px solid #EDE5D8;border-radius:20px">
  <p style="font-size:.58rem;font-weight:800;letter-spacing:.22em;text-transform:uppercase;color:#870000;margin-bottom:18px">Booking Process</p>
  <div style="display:flex;flex-direction:column;gap:16px">
    ...
    <div style="display:flex;gap:13px;align-items:flex-start">
      <div style="width:26px;height:26px;border-radius:50%;background:#870000;color:#fff;font-size:.68rem;font-weight:800;display:flex;align-items:center;justify-content:center;flex-shrink:0;margin-top:2px"><?= $i+1 ?></div>
      <div>
...
<!-- PRICE CTA -->
<div style="margin:14px 16px 0;background:linear-gradient(135deg,#a00000 20%,#870000 80%);border-radius:20px;padding:22px 20px;display:flex;align-items:center;justify-content:space-between;gap:14px">
  <div>
  ...
  <a href="#mandalis" style="display:inline-flex;align-items:center;gap:6px;background:#fbc04a;color:#870000;font-size:.8rem;font-weight:800;padding:14px 18px;border-radius:12px;text-decoration:none;white-space:nowrap">
...
<div style="margin:14px 16px 28px;padding:16px 18px;background:#F0FDF4;border:1px solid #BBF7D0;border-radius:16px;display:flex;align-items:center;gap:14px">
  <div style="width:42px;height:42px;border-radius:11px;background:#870000;display:flex;align-items:center;justify-content:center;flex-shrink:0">
  ...
  <a href="https://wa.me/919999999999?text=I+need+a+bhajan+mandali+for+my+event" target="_blank" style="background:#870000;color:#fff;font-size:.74rem;font-weight:700;padding:9px 13px;border-radius:9px;text-decoration:none;white-space:nowrap">Chat →</a>
</div>
