...
<div class="cat-purohit" style="padding:44px 24px 36px">
  ...
  <div style="display:flex;gap:10px;flex-wrap:wrap">
    <a href="#pujas" style="display:inline-flex;align-items:center;gap:7px;background:#fbc04a;color:#7A1E12 !important;font-size:.82rem;font-weight:800;padding:13px 22px;border-radius:10px;text-decoration:none">Book a Puja →</a>
...
<div style="padding:28px 20px 24px;background:#FDFCF9;border-bottom:1px solid #EDE5D8">
  <p style="font-size:.58rem;font-weight:800;letter-spacing:.22em;text-transform:uppercase;color:#870000;margin-bottom:20px">How It Works</p>
  <div style="display:flex;flex-direction:column;gap:18px">
    ...
    <div style="display:flex;gap:14px;align-items:flex-start">
      <div style="width:34px;height:34px;border-radius:9px;background:<?= ['#7A1E12','#870000','#870000'][$i] ?>;color:#fff;font-size:.72rem;font-weight:800;display:flex;align-items:center;justify-content:center;flex-shrink:0"><?= $num ?></div>
      <div>
...
<div id="pujas" style="padding:24px 16px 8px">
  ...
  <div class="card-grid">
    ...
    <div style="text-align:center;padding:48px 20px;color:#9A7A58;grid-column:1/-1">
      <svg style="margin:0 auto 10px;display:block" width="36" height="36" fill="none" stroke="#870000" stroke-width="1.4" viewBox="0 0 24 24"><use href="#ic-flame"/></svg>
    ...
    <a href="<?= base_url('purohit-puja/'.$puja['slug']) ?>" class="lotus-card reveal"
       style="display:flex;align-items:center;gap:14px;background:#fbc04a;border:1px solid #EDE5D8;border-radius:16px;padding:16px;text-decoration:none">
      ...
      <div style="flex:1;min-width:0">
        ...
        <div style="display:flex;align-items:center;gap:6px;flex-wrap:wrap">
          <?php if($puja['samagri_included']??true): ?><span style="font-size:.68rem;font-weight:700;color:#870000;background:#FFF8F8;padding:3px 9px;border-radius:20px">✓ Kit included</span><?php endif; ?>
          <?php if(!empty($puja['starting_price'])): ?><span style="font-size:.7rem;font-weight:600;color:#870000">From ₹<?= number_format($puja['starting_price']) ?></span><?php endif; ?>
        </div>
      </div>
...
<!-- TRUST GRID -->
<div style="margin:12px 16px 0;padding:22px;background:#FEF5C7;border:1px solid #EDE5D8;border-radius:20px">
  <p style="font-size:.58rem;font-weight:800;letter-spacing:.2em;text-transform:uppercase;color:#870000;margin-bottom:16px">Why Families Choose Us</p>
  <div style="display:grid;grid-template-columns:1fr 1fr;gap:16px">
    <?php foreach([
      ['#7A1E12','ic-star','Verified &amp; Certified','Every pandit is tested &amp; certified'],
      ['#870000','ic-cart','Samagri Delivered','Complete kit at your door before puja'],
      ['#870000','ic-doc','Authentic Vidhi','Rituals per ancient shastra tradition'],
      ['#870000','ic-chat','WhatsApp Support','Help before, during &amp; after your puja'],
    ] as [$col,$ic,$title,$sub]): ?>
    <div>
...
<!-- PRICE + CTA -->
<div style="margin:14px 16px 0;background:linear-gradient(
135deg,#a00000 20%,#870000 80%);border-radius:20px;padding:22px 20px;display:flex;align-items:center;justify-content:space-between;gap:14px">
  <div>
  ...
  <a href="#pujas" style="display:inline-flex;align-items:center;gap:6px;background:#fbc04a;color:#7A1E12;font-size:.8rem;font-weight:800;padding:14px 18px;border-radius:12px;text-decoration:none;white-space:nowrap">
    Book Now <svg width="13" height="13" fill="none" stroke="currentColor" stroke-width="2.5" viewBox="0 0 24 24"><use href="#ic-arrow"/></svg>
  </a>
</div>

<!-- WHATSAPP ESCAPE -->
<div style="margin:14px 16px 28px;padding:16px 18px;background:#FFF8F8;border:1px solid #E5B5B5;border-radius:16px;display:flex;align-items:center;gap:14px">
  <div style="width:42px;height:42px;border-radius:11px;color:#870000;display:flex;align-items:center;justify-content:center;flex-shrink:0">
    <svg width="21" height="21" fill="none" stroke="#fff" stroke-width="1.7" viewBox="0 0 24 24"><use href="#ic-chat"/></svg>
  </div>
  <div style="flex:1">
    <div style="font-weight:700;font-size:.88rem;color:#870000;margin-bottom:2px">Not sure which puja?</div>
    <div style="font-size:.76rem;color:#870000;line-height:1.45">Talk to our Vedic team — free guidance</div>
  </div>
  <a href="https://wa.me/919999999999?text=Help+me+choose+the+right+puja" target="_blank" style="color:#870000;color:#fff;font-size:.74rem;font-weight:700;padding:9px 13px;border-radius:9px;text-decoration:none;white-space:nowrap">Chat →</a>
</div>
